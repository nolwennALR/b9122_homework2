...
for i in range(0,maxNumPressRelease):
    ...
    text_file = open(r'/Users/naa2195/Documents/1st Year/Computing for Business Research/Problem Sets/PS2/UN Press Releases/HW2_Q1_1_html_'+str(i+1)+'.txt', 'w')
...
for i in range(0,15):
    ...
    text_file.close()
    # Save entire html file
    text_file = open(r'/Users/naa2195/Documents/1st Year/Computing for Business Research/Problem Sets/PS2/EU Parliament Press Releases/HW2_Q1_2_html_'+str(i+1)+'.txt', 'w')
    text_file.write(press_release_html[i])
    text_file.close()
    print("\nPress Release saved in txt format")
